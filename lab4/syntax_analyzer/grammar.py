from syntax_analyzer.rule import Rule
from syntax_tree import Tree
from tools import list_compare, Integer
from syntax_analyzer.parsing import OperatorPrecedenceParsing
...
class Grammar(object):
    ...
    def grammar_parsing(self, char_string):
        string = char_string.split(' ')
        a = OperatorPrecedenceParsing()
        return a.operator_precedence_parsing(self, string)
